...
subprocess.run(['docker', 'exec', 'spice', './run_dans_script.sh', 'pic.jpg'])
subprocess.run(['rm', sys.argv[1]])

ltspice_proc = subprocess.Popen(['wine', '/home/adam/.wine/drive_c/Program Files/LTC/LTspiceXVII/XVIIx64.exe', '-big', '-b', f'C:\\users\\adam\\Desktop\\sipl\\pythonProject\\Dans_rebuild\\output.asc'])
